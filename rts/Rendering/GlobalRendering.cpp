...
CONFIG(bool, VRMode).defaultValue(false).description("Enable VR stereo rendering using OpenXR (requires SteamVR). Renders the world in stereo for VR headsets with head tracking.");
